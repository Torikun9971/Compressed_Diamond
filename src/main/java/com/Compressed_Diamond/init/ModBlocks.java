...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> COLORLESS_DIAMOND_BLOCK = registerBlockItem("colorless_diamond_block", () -> new DiamondBlockTranslucent(BlockBehaviour.Properties.of().sound(SoundType.METAL).strength(8.0F, 9.0F).requiresCorrectToolForDrops(), "3486784401"));
    ...
    public static final RegistryObject<Block> COMPRESSED_COLORLESS_DIAMOND_BLOCK = registerBlockItem("compressed_colorless_diamond_block", () -> new CompressedDiamondBlockTranslucent(BlockBehaviour.Properties.of().sound(SoundType.METAL).strength(8.5F, 9.5F).requiresCorrectToolForDrops(), "31381059609"));
